...
df.compa.b$prob.pois<-probesti.pois[1:13]
df.compa.b$prob.bneg<-probesti.bneg[1:13]
str(df.compa.b)

##! Correccion de probabilidad estimada mediante modelos ajustados
...
max.ll.bneg<-optim.loglik.bneg$value
