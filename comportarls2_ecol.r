...
## ║   transformaciones de la variable predictora y respuesta.     ║
...
y.esperado <- b0.hat + b1.hat * t.ast

##- Grafico de dispersion con valor esperado
plot(largo~edad, data=df)
lines(t.ast, y.esperado, col="red",lwd=2)
...
t.ast<-seq(1,8,by=0.01)
y.esperado <- b0.hat + b1.hat * t.ast
y.esperado2 <- b0.hat2 + b1.hat2 * (1/t.ast)

##- Grafico de dispersion con valor esperado
plot(largo~edad, data=df)
lines(t.ast, y.esperado, col="red",lwd=2)
lines(t.ast, y.esperado2, col="blue",lwd=2)
##!==fin del grafico de comportamiento
...
t.ast<-seq(1,8,by=0.01)
y.esperado <- b0.hat + b1.hat * t.ast
y.esperado2 <- (b0.hat2 + b1.hat2 * log(t.ast))^2
y.esperado3 <- exp(b0.hat3 + b1.hat3 *(1/sqrt(t.ast)))

##- Grafico de dispersion con valor esperado
plot(largo~edad, data=df,col="gray",las=1)
lines(t.ast, y.esperado, col="red",lwd=2)
lines(t.ast, y.esperado2, col="blue",lwd=2)
lines(t.ast, y.esperado3, col="green",lwd=2)
##!==fin del grafico de comportamiento
