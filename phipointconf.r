##!╔════════════════════════════════════════════════════════════════╗
##*║ Script: "phipointconf.r"                                       ║
##+║ Sobre:  Prueba de hipotesis e intervalo confianza.             ║
##-║ Detalles: Que relacion tienen una prueba de hipotesis y un     ║
##-║  intervalo confidencial en inferencia estadistica?.            ║
## ║                                                                ║
## ║                                                                ║
...
##+======================================================
##! IV. Relacion entre prueba de hipotesis e intervalos confidenciales
##+======================================================

##- a. Error de muestreo (o margen de error)
...
##!══════════════════════════════════════════════════════════════════╗
##+ Tarea                                                            ║
##- 1. Calcule el intervalo de confianza para un nivel de            ║
##-   significancia de 0.01                                          ║
##- 2. Compare su resultado con el anterior intervalo de confianza   ║
##!══════════════════════════════════════════════════════════════════╝
