...
##Maximizar la funcion de maxima verosimilitud de la Fdp de Weibull
...
plot(frobs~espevida.l, data=df.compfrec,type = "o",las=1,bty="l",
     ylab="Frecuencia relativa",
     xlab="Esperanza de vida (a\u00f1os)")
lines(df.compfrec$espevida.l,df.compfrec$prob.cl,col="red",type = "o")
legend("topleft",c("Observada","Fdp de Weibull"),
       col=c("black","red"),
       lty = c(1,1), pch=c(1,1))
